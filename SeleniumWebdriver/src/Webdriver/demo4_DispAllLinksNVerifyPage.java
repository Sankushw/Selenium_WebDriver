...
public class demo4_DispAllLinksNVerifyPage {
	...
	public static void main(String[] args) throws MalformedURLException, IOException
	{
     ...
     // List<WebElement> linksq= new ArrayList<WebElement>(driver.findElementsByTagName("a"));    //another way of writing above line
		System.out.println("The no of links on this page is= "+links.size());
		
		//storing all link labels in a static array
